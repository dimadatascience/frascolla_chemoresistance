...
if (nrow(genelist_df_A) > 0) {
  ...
  warning("genelist_df_A is empty! Skipping GO enrichment.")
  skip_ORA <- TRUE
}
...
if (exists("skip_ORA") && skip_ORA) {
  cat("Skipping ORA analysis because genelist_df_A is empty.\n")
} else {
