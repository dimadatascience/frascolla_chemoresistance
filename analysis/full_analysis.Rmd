...
if (!("condition" %in% valid_vars)) {
  stop("'condition' must be present in valid_vars")
}

has_time <- "time" %in% valid_vars
has_batch <- "batch" %in% valid_vars
...
out_A <- specific_deseq2(
  ...
  contrast = list(
    coef_list <- c(
      "condition_shIFI6_1_vs_shSCR",
      "conditionshIFI6_1.timeDay1",
      "conditionshIFI6_1.timeDay2",
      "conditionshIFI6_1.timeDay3",
      "conditionshIFI6_1.timeDay4",
      "conditionshIFI6_1.timeDay5"
    )
  )
)
# extract output
