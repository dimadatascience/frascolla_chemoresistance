...
ifi6$group = unlist(lapply(strsplit(ifi6$sample, "_D"), "[[", 1))
...
```{r load_data}
list1 <- read.csv("/hpcnfs/scratch/DIMA/gmariani/PROJECTS/rna/reports/projects/frascolla/frascolla_chemoresistance/data/UNIQUELIST_shIFI6_vs_shIFI6.csv")[[1]]
list2 <- read.csv("/hpcnfs/scratch/DIMA/gmariani/PROJECTS/rna/reports/projects/frascolla/frascolla_chemoresistance/data/UNIQUELIST_shIFI6_vs_shSCR.csv")[[1]]
